	     ...
	     public static Iterable<Object[]> data() {
	         return Arrays.asList(
	        		 new Object[][] { 
	        			 ...
	        			 { FiguraType.CILINDRO, Cilindro.class, new double[]{3.0,4.0}},
	        			 { FiguraType.ESFERA, Esfera.class, new double[]{4.0}},
	        			 { FiguraType.PRISMA, Prisma.class, new double[]{2.0,8.0,2.0}},
	        			 { FiguraType.PIRAMIDE, Piramide.class, new double[]{10.0,5.0}},
